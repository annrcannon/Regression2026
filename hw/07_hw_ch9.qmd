...
-   Create a new quarto document and give it a sensible name such as *hw7*.
...
e. Table 1 shows a portion of Table 2: Results of Hierarchical Linear Modeling Analyses Modeling Gang Involvement from Walker and Barnes (2001).  Provide interpretations of significant coefficients in context (look "*").
...
e. Fit a linear trend to the data from each of the 82 subjects using `age` as the time variable.  Generate histograms as in Figure [9.10](https://bookdown.org/roback/bookdown-BeyondMLR/ch-lon.html#fig:lon-histmat1) showing the results of these 82 linear regression lines, and generate pairs of boxplots as in Figure [9.12](https://bookdown.org/roback/bookdown-BeyondMLR/ch-lon.html#fig:lon-box2) for `coa` and `male`.  No commentary necessary.  [Hint: to produce Figure [9.12](https://bookdown.org/roback/bookdown-BeyondMLR/ch-lon.html#fig:lon-box2), you will need a data frame with one observation per subject.]
