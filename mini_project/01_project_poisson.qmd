...
3)  Create *qmd* or script files as needed.
...
At least 1 group should work with the *macbride_fish.csv* data. See the data dictionary in the data folder to learn more.
...
| Submit your Final Report | Submit HTML 10/29 at 11:59 pm |
