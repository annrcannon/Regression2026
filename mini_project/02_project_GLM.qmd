...
##### 2) Find an appropriate data set.
  ...
  -   Logistic regression is a category of glms. They require that the response variable either be an indicator variable, or counts of successes in some number of trials (which may vary over observations)
...
- You can also use any dataset from our Beyond Mulitple Linear Regression textbook, Chapters 1-6, that we have not done data anlaysis on already for homework. 

##### 3) Write out the anticipated cleaning and/or feature engineering steps you will need to take. Some examples
...
| Fit, Assess, and Compare Regression Models | 10:30 am - 11:00 am, 1:00 pm - 2:10 pm |
| Prepare presentation                       | 2:10 pm - 2:40 pm                      |
| Present your findings                      | 2:40 pm - 3:00 pm                      |
| Submit your Final Report                   | Submit HTML Sunday 11/2 at 11:59 pm    |

### Grading

Each Mini Project is worth 50 points. The following rubric applies to the combination of your report and presentation. 
...
When you are finished with your report, render the final document. Once rendered, you can download your file by:
